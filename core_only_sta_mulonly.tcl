...
set netlist_file "/work/OpenLane/designs/riscv_top/runs/syn_single_mulonly_20260219/results/synthesis/Riscv151.v"
...
# Core-only: ignore top-level IO timing
...
puts "===== top max timing path ====="
report_checks -path_delay max -group_count 1 -sort_by_slack
puts "===== summary ====="
